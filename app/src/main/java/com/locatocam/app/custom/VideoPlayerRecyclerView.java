...
import com.locatocam.app.views.home.FeedsAdapter;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private ArrayList<FeedItem> mediaObjects = new ArrayList<>();
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        FeedsAdapter.VideoPlayerViewHolder holder = (FeedsAdapter.VideoPlayerViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
    ...
    public void setMediaObjects(ArrayList<FeedItem> mediaObjects){
