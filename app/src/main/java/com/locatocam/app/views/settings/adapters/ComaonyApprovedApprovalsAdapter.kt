 ...
 private val companyApprovedClickEvents: CompanyApprovedClickEvents) : RecyclerView.Adapter<ComaonyApprovedApprovalsAdapter.viewHolder>() {
    ...
    override fun onBindViewHolder(holder: viewHolder, position: Int) {
        ...
        holder.btn_reject.setOnClickListener {
            companyApprovedClickEvents.ApprovedReject(holder.btn_reject,list[position],"approved","post")
        }
        holder.btn_view.setOnClickListener {
            companyApprovedClickEvents.Approvedview(holder.btn_view,list[position],"approved","post")
        }
    }
