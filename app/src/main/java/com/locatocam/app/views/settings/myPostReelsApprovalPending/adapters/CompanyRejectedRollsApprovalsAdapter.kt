...
class CompanyRejectedRollsApprovalsAdapter (private val list: List<com.locatocam.app.data.responses.settings.rejectedPost.Detail>, private val context: Context,
