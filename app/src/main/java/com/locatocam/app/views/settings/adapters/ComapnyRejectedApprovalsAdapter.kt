...
class ComapnyRejectedApprovalsAdapter (private val list: MutableList<com.locatocam.app.data.responses.settings.companyRejected.Detail>, private val context: Context,
