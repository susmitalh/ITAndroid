...
public class VideoTimelineView  extends View {
    ...
    public void updateColors() {
       backgroundGrayPaint.setColor(Color.BLUE);
        thumbRipplePaint.setColor(Color.BLUE);
        roundCornersSize = 0;
    ...
    public static class TimeHintView extends View {
        ...
        public TimeHintView(Context context) {
            ...
            tooltipBackground =Theme.createRoundRectDrawable(AndroidUtilities.dp(5), Color.BLUE);
            updateColors();
            setTime(0);
        }
        ...
        public void updateColors() {
            ...
            tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.dp(5),Color.BLUE);
            tooltipBackgroundArrow.setColorFilter(new PorterDuffColorFilter(Color.BLUE, PorterDuff.Mode.MULTIPLY));
        }
