...
import com.locatocam.app.views.settings.CompanyPendingClickEvents

class CompanyPendingApprovalAdapter(private val list: MutableList<Detail>, private val context: Context,
       private val companyPendingClickEvents: CompanyPendingClickEvents
) : RecyclerView.Adapter<CompanyPendingApprovalAdapter.viewHolder>() {
    ...
    override fun onBindViewHolder(holder: viewHolder, position: Int) {
        ...
        holder.btn_Reject.setOnClickListener {
            companyPendingClickEvents.PendingReject(holder.btn_Reject,list[position],"pending","post")
        }
        holder.btn_View.setOnClickListener {
            companyPendingClickEvents.Pendingview(holder.btn_View,list[position],"pending","post")
        }
        holder.btn_approve.setOnClickListener {
            companyPendingClickEvents.PendingApprove(holder.btn_View,list[position],"pending","post")
        }
    }
