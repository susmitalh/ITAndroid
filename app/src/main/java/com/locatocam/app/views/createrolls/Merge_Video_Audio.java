...
public class Merge_Video_Audio extends AsyncTask<String,String,String> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        /*if(context instanceof Preview_Video_A){
            ((Preview_Video_A)context).afterExicute();
        }*/
    }
    ...
    public void Go_To_preview_Activity(){
        ((Preview_Video_A)context).Set_Player(Variables.gallery_trimed_video);
       // Log.i("ikjjjjjjj","lo99999999");
        ...
        public void run() {
            ...
            try {
                ...
                for (Track t : m.getTracks()) {
                 ...
                 Track nuAudio = new MP3TrackImpl(new FileDataSourceImpl(audio));
                ...
                try {
                    ...
                    Log.d(Variables.tag,e.getMessage());
