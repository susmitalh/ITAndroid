...
public class GalleryListAdapterMedia extends RecyclerView.Adapter<GalleryListAdapterMedia.GalleryViewHolder> {
    private List<GalItemX> videoItems;
    public ListGalleryImVdoActivity activity;
    public GalleryListAdapterMedia(List<GalItemX> videoItems, ListGalleryImVdoActivity activity) {
        ...
        if(videoItems.get(position).getUri()!=null){
            ...
            holder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    activity.save(videoItems.get(position).getUri(),"image");
                }
            });
