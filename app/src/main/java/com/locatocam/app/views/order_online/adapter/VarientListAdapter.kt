...
class VarientListAdapter(private val varient:List<Varient>, private val clickEvents: VarientItemClick):
    RecyclerView.Adapter<VarientListAdapter.TopInfluencerViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TopInfluencerViewHolder, position: Int) {
        ...
        item.apply {
            holder.itemName.text = varient_name
