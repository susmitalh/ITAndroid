...
interface CompanyRejectedClickEvents {
    fun Rejectedview(v: View,data: com.locatocam.app.data.responses.settings.companyRejected.Detail,process:String,type:String)
    fun RejectedRepost(v: View,data: com.locatocam.app.data.responses.settings.companyRejected.Detail,process:String,type:String)
