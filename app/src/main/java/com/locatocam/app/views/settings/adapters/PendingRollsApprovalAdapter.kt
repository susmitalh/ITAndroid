...
class PendingRollsApprovalAdapter (private val list: MutableList<Detail>, private val context: Context,private val click: PendingClickEvents) : RecyclerView.Adapter<PendingRollsApprovalAdapter.viewHolder>() {
