...
public class AudioListAdapterlocal extends RecyclerView.Adapter<AudioListAdapterlocal.GalleryViewHolder> {
    private List<GalleryVideoItem> videoItems;
    public LocalAudioFragment videoRecorder;

    public AudioListAdapterlocal(List<GalleryVideoItem> videoItems, LocalAudioFragment fragment) {
    ...
    public void onBindViewHolder(@NonNull GalleryViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.play_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    videoRecorder.downloadAndPlay(videoItems.get(position).getPath(),holder.progress,videoItems.get(position).getLength());
